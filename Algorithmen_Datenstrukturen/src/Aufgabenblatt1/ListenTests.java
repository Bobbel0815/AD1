...
public class ListenTests {
	...
	private Element startelement = new Element(0);

	private Liste erzeugeLeereListe() {
		return new EinfachVerkettet();
	}
	...
	public void testInsert() {
		...
		liste = erzeugeListe(1, startelement);
		assertEquals(1, liste.size());

		liste = erzeugeListe(3, startelement);
		...
		liste = erzeugeLeereListe();
		assertNotNull(liste.insert(null, startelement));
	}
	...
	public void testInsertUngueltigePos() {
		...
		liste = erzeugeListe(100, startelement);
		liste.insert(new Knoten(), null);
	...
	public void testInsertNull() {
		...
		liste = erzeugeListe(10, startelement);
	...
	public void testDelete() {
		...
		liste = erzeugeListe(1, startelement);
		assertEquals(1, liste.size());
		liste.delete(liste.find(startelement));
		assertEquals(0, liste.size());
	}
	...
	public void testDeleteUngueltigerKnoten() {
		Liste liste = erzeugeListe(30, startelement);
	...
	public void testFind() {
		Liste liste = erzeugeLeereListe();
		Knoten knoten = liste.insert(null, startelement);
		assertTrue(knoten.equals(liste.find(startelement)));
	}

	@Test
	public void testRetrieve() {
		Liste liste = erzeugeListe(1, startelement);

		Knoten knoten = liste.find(startelement);
		assertEquals(startelement, liste.retrieve(knoten));
	}
	...
	public void testConcatNull() {
		...
		liste = erzeugeListe(50, startelement);
	...
	public void testConcatLeer() {
		...
		Liste l2 = erzeugeListe(10, startelement);

		l1.concat(l2);
		assertEquals(10, l1.size());

		l1 = erzeugeLeereListe();
		l2 = erzeugeListe(10, startelement);
	...
	public void testConcat() {
		Liste l1 = erzeugeListe(1000, startelement);
		Liste l2 = erzeugeListe(10, startelement);
		l1.concat(l2);
